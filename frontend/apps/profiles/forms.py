...
class ScaplUserUpdateForm(cforms.GenericUserUpdateForm, ThemeSpecificMixin):
...
class ScaplUserCreationForm(cforms.GenericUserCreationForm, ThemeSpecificMixin):
